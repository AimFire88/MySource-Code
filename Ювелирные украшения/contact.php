...
<!-- Список товаров -->
<div class="ui container">
				<div class="ui stacked segment" style="font-family: 'Ubuntu Light';">
  <p style="text-align: center;">Интернет-магазин Фелечита - это качество, разумные цены, удобный сервис и свобода выбора.

Мы постоянно работаем над улучшением нашего продукта, для того, чтобы Вам было удобно.
</p>
<p style="text-align: right;"> <i>С уважением и  любовью к нашим покупателям..</i></p>
<p style="text-align: right;"> <i><b>Интернет-магазин Фелечита</i> </b> </p>
</div>
</div>
